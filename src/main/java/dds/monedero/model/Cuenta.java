...
public class Cuenta {
  ...
  public void sacar(double cuanto) {
    ...
    Movimiento extraccion = new Extraccion(LocalDate.now(), cuanto);
    extraccion.agregateA(this);
  }
